...
console.log(message); //Added message in parenthesis, then the semicolon
...
console.log(myVariable); //Declared a variable for myVariable
...
console.log(greeting); //Added console log which is a correct function
...
//Added a property to obj, which fixes the error
...
console.log("User info: " + JSON.stringify(user)); //Added JSON stringify to this to fix the error
...
*/
let num = "10";
console.log(Number(num) + 5); //Added Number() to fix the issue
